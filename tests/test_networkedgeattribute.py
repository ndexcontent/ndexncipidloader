...
class TestNetworkEdgeAttribute(unittest.TestCase):
    """Tests for `NetworkEdgeAttribute` class."""
    ...
    def test_add_attribute_to_edge(self):
        nef = NetworkEdgeAttribute(name='foo', value='someval')
        net = NiceCXNetwork()
    ...
    def test__eq__(self):
        ...
        nef1 = NetworkEdgeAttribute(name='name1', value='foo',
                                    data_type='string')
        nef2 = NetworkEdgeAttribute(name='name2', value='foo',
                                    data_type='string')
